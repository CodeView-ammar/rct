...
(function (b) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (c) { return b(c, window, document) }) : "object" === typeof exports ? module.exports = function (c, g) { c || (c = window);
 ...
 return b(g, c, c.document) } : b(jQuery, window, document) })
 (function (b, c, g, y) {
    var u = b.fn.dataTable, n = g.createElement("a"), 
    v = function (a) {
        n.href = a;
         a = n.host;
         -1 === a.indexOf("/") &&
     ...
     u.ext.buttons.print = {
        ...
        text: function (a) 
        { return a.i18n("buttons.print", "طباعة") },
        ...
        {
            return k.settings()[0].aoColumns[k.column(d).index()].sClass }).toArray(),
            r = function (d, e) {
                for (var x = "<tr>", l = 0, z = d.length;l < z;l++)
                x +="<" + e + " " + (w[l] ? 'class="' + w[l] + '"' : "") + ">" + (null === d[l] || d[l] === y ? "" : d[l]) + "</" + e + ">";
                return x + "</tr>"
            }, m = '<table class="' + k.table().node().className + '">';
             h.header && (m += "<thead>" + r(a.header, "th") + "</thead>");
             m += "<tbody>";
             for (var t = 0, A = a.body.length;
                 t < A;
                 t++)m += r(a.body[t], "td");
             m += "</tbody>";
            ...
            //  f.document.close();
             ...
             try { f.document.head.innerHTML = q } 
            catch (d) 
            ...
            b(f.document.body).addClass("dt-print-view");
             ...
             a = function () { h.autoPrint && (f.print()) };
